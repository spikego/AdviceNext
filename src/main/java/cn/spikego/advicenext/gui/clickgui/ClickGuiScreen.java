package cn.spikego.advicenext.gui.clickgui;
...
import cn.spikego.advicenext.gui.clickgui.animation.AnimationUtil;
...
public class ClickGuiScreen extends Screen {
    ...
    private void updateNumberSetting(NumberSetting<?> setting, int mouseX, int sliderX, int sliderWidth) {
        ...
        if (setting instanceof cn.spikego.advicenext.features.value.slider.IntSetting) {
            ((cn.spikego.advicenext.features.value.slider.IntSetting)setting).setValue((int)newValue);
        } else if (setting instanceof cn.spikego.advicenext.features.value.slider.FloatSetting) {
            ((cn.spikego.advicenext.features.value.slider.FloatSetting)setting).setValue((float)newValue);
        } else if (setting instanceof cn.spikego.advicenext.features.value.slider.DoubleSetting) {
            ((cn.spikego.advicenext.features.value.slider.DoubleSetting)setting).setValue(newValue);
        }
    }
