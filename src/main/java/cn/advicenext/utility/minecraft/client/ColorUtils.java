...
import cn.advicenext.utility.client.math.MathUtils;
...
public class ColorUtils {
    ...
    public static Color getRainbow() {
        return new Color(Color.HSBtoRGB((float) ((double) MinecraftClient.getInstance().player.age / 50.0 + Math.sin((double) 1 / 50.0 * 1.6)) % 1.0f, 0.5f, 1.0f));
    }
